...
public static class PhotonNetwork
{
    ...
    private static int sendInterval = 5; // in miliseconds.

    private static int sendIntervalOnSerialize = 10; // in miliseconds. I.e. 100 = 100ms which makes 10 times/second
